...
############ BACK UP STORAGE LOCATION USING DBBACKUP ######################
#DBBACKUP_STORAGE = 'django.core.files.storage.FileSystemStorage'
#DBBACKUP_STORAGE_OPTIONS = {'location': '../../db-backups'}
########### PRINTS DATE TIME FOR EACH BACKUP ##############################
#DBBACKUP_FILENAME_TEMPLATE = '{datetime}-{databasename}.{extension}'
#DDBACKUP_MEDIA_FILENAME_TEMPLATE = '{datetime}-media.{extension}'
